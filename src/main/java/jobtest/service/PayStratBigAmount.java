...
/**
 * стратегии оплаты: любая покупка дороже 300 рублей
 * бонус 30% в банк
 * @author sanek
 *
 */
public class PayStratBigAmount extends PayStratCommon {

	
	/**
	 * процент бонуса за покупку  (%/100)
	 */
	public static BigDecimal BONUS_PERCENT = new BigDecimal(0.30);
